...
import { REMOVE_ITEM, INCREASE, DECREASE, TOGGLE_AMOUNT } from "../actions";
...
const mapDispatchToProps = (dispatch, ownProps) => {
  {
    /*  the second parameter for props signifies that i want to use the items own props - console.log(ownProps) shows object will all props the items */
  }
